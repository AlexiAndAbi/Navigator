...
function Page2() {
  ...
  const checkAnswer = () => {
    ...
    if (acceptableAnswers.some(answer => userInput.toLowerCase().trim() === answer)) {
  ...
  return (
    <div className="gradient_background">
      <button className="navigate-button" onClick={handleNavigation} style={{ border: '2px solid white' }}>back</button>
